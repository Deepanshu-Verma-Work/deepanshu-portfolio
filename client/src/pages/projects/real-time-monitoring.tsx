                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-display font-bold uppercase tracking-tight mb-6 leading-none">
                            Real-time Machine Usage Monitoring
                        </h1>
                        <p className="text-xl text-muted-foreground font-heading leading-relaxed max-w-2xl">
                            A scalable solution to collect, process, and visualize real-time network flow logs from 1000+ machines, providing actionable insights into machine usage and network activity.
                        </p>
                    </motion.div>
                        ...
                        <div className="md:col-span-2 space-y-12">
                            <section>
                                ...
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    Monitoring a large fleet of machines generates massive amounts of log data. The challenge was to ingest this data in real-time, process it efficiently to extract meaningful metrics, and visualize it for operations teams to detect anomalies and optimize resource usage without latency.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="space-y-4 text-muted-foreground">
                                    <li className="flex gap-4">
                                        ...
                                        <span>VPC Flow Logs capture network traffic from over 1000 EC2 instances.</span>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="font-mono text-primary font-bold">02</span>
                                        <span>Logs are aggregated and stored in Amazon S3 for durability and scalability.</span>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="font-mono text-primary font-bold">03</span>
                                        <span>AWS Glue crawlers catalog the data, making it queryable via Amazon Athena.</span>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="font-mono text-primary font-bold">04</span>
                                        <span>Amazon QuickSight connects to Athena to render interactive, real-time dashboards.</span>
                                    </li>
                                </ul>
                            </section>
                        </div>
                        ...
                        <div className="space-y-12">
                            <section>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["VPC Flow Logs", "Amazon S3", "AWS Glue", "Amazon Athena", "Amazon QuickSight", "Python", "CloudFormation"].map((tech) => (
