            ...
            <div className="relative z-10 flex items-center gap-2 md:gap-12 w-full max-w-2xl justify-between">
                ...
                <div className="flex flex-col items-center gap-2 md:gap-3">
                    <div className="relative">
                        <motion.div
                            ...
                            className="p-2 md:p-4 rounded-2xl bg-blue-500/20 border border-blue-400/30 text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.2)]"
                        >
                            <User className="w-6 h-6 md:w-8 md:h-8" />
                        </motion.div>
                        {/* Chat Bubble Animation */}
                        <motion.div
                            className="absolute -top-4 -right-4 bg-blue-500 text-white text-[8px] md:text-[10px] px-1.5 py-0.5 md:px-2 md:py-1 rounded-lg rounded-bl-none shadow-lg border border-blue-400"
                            initial={{ opacity: 0, y: 5, scale: 0.8 }}
                            animate={{ opacity: [0, 1, 1, 0], y: [5, 0, 0, -5], scale: [0.8, 1, 1, 0.8] }}
                            transition={{ duration: 3, repeat: Infinity, times: [0, 0.1, 0.8, 1] }}
                        >
                            <MessageSquare className="w-2 h-2 md:w-3 md:h-3 inline-block mr-1" />
                            Query
                        </motion.div>
                    </div>
                    <span className="text-[10px] md:text-xs font-bold tracking-wider text-blue-200 uppercase">User</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 md:gap-3">
                    <div className="relative">
                        ...
                        />
                        <div className="p-3 md:p-5 rounded-full bg-zinc-900 border border-zinc-700 text-white shadow-xl relative z-10">
                    ...
                    <span className="text-[10px] md:text-xs font-bold tracking-wider text-zinc-300 uppercase">Orchestrator</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 md:gap-3">
                    <div className="relative">
                        <motion.div
                            ...
                            className="p-2 md:p-4 rounded-2xl bg-purple-500/20 border border-purple-400/30 text-purple-400 relative z-10"
                        >
                    ...
                    <span className="text-[10px] md:text-xs font-bold tracking-wider text-purple-200 uppercase">LLM</span>
                </div>
            </div>
        </div>
    );
